...
Tramite l'interfaccia a riga di comando, eseguire:
...
Una volta soddisfatti i prerequisiti, il server può essere inizializzato eseguendo il modulo principale:
`python app.py`
